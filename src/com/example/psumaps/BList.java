	...
	// The data to show
		...
		private void initList() {
		   ...
		   // buildingsList.add(createBuilding("building", "Campus and Grounds Trailer"));
			...
			mlevels.put("Parking Structure 2",5);
			mlevels.put("Parking Structure 3",5);
			mlevels.put("Peter W. Stott Center",3);
			mlevels.put("Research Greenhouse",1);
			mlevels.put("Science Building One",4);
			mlevels.put("Simon Benson House",3);
			mlevels.put("Science and Education Center",3);
			mlevels.put("Stephen E. Epler Hall",5);
			mlevels.put("South Greenhouse",1);
			mlevels.put("Shattuck Hall",4);
			mlevels.put("Smith Memorial Student Union",5);
			mlevels.put("Science Research and Teaching Center",0);
			mlevels.put("Stratford Building",3);
			mlevels.put("Saint Helens Building",5);
			mlevels.put("University Center Building",5);
			mlevels.put("University Honors Program",5);
			mlevels.put("University Place",1);
			mlevels.put("Urban Center",4);
			mlevels.put("University Services Building",3);
			mlevels.put("University Technology Services",5);
			mlevels.put("West Heating Plant",1);
			mlevels.put("XSB",3);
